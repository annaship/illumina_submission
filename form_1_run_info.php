...
<table class="fields" id="run_infoForm_run_info-fields"><tbody>
  ...
  <td align="left"><input class="text_inp" type="text" name="rundate" id="run_infoForm_rundate" value="" size="30"/></td>
  </tr>
  
  <tr class="fields">
  <td class="fields" align="left"><label for="run_infoForm_Path to raw data">Path to raw data</label></td>
  <td align="left">/xraid2-2/sequencing/Illumina/<input class="text_inp" type="text" name="Path to raw data" id="run_infoForm_Path to raw data" value="" size="30"/></td>
  </tr>

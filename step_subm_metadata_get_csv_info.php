<?php 
  ...
  $row_num = 0;
  $csv_headers_needed = array("adaptor", "barcode", "barcode_index", "concentration", "dataset_description", "dataset_name", "date_initial", "date_updated", "direction",
...
// 		"submit_code", "tube_label");
  ...
  *
  *
  *  all fields on Aug 5 2013
  * "adaptor", "barcode", "barcode_index", "concentration", "dataset_description", "dataset_name", "date_initial", "date_updated", "direction",
  *  "dna_region", "domain", "duplicate", "env_sample_source_id", "enzyme", "id", "insert_size", "lane", 
  *  "on_vamps", "op_amp", "op_empcr", "op_seq", "overlap", "platform", "pool", "primer_suite", "project_name", 
  *  "quant_method", "read_length", "rundate", "runkey", "sample_received", "submit_code", "trim_distal", 
